...
<div transition:slide class="flex flex-row bg-white rounded-lg shadow">
  ...
  <div class="flex flex-col sm:flex-row justify-between w-[90vw] sm:w-[72vw]">
    ...
    <a href={data.artworkUrl100.replace(/100x100bb/g, "10000x10000-999")} target="_blank" rel="noreferrer" class="flex items-center justify-center w-full h-full text-gray-600 transition-colors border-t-2 sm:w-16 sm:border-l-2 sm:border-t-0 hover:bg-gray-200 sm:rounded-r-md">
